...
export const SiCanva: IconType = ({ className, style, ...rest }) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const SiOpenAI: IconType = ({ className, style, ...rest }) => (
  <svg role="img" viewBox="0 0 24 24" fill="currentColor" className={className} style={style} {...rest}>
...
export type RoadmapPlatformName = PlatformName;
...
const BRANDS: Record<RoadmapPlatformName, Brand> = {
  ...
  bluesky: { label: "Bluesky", Icon: FaBluesky, hex: "#0285FF" },
  woocommerce: { label: "WooCommerce", Icon: SiWoocommerce, hex: "#96588A" },
  ...
  canva: { label: "Canva", Icon: SiCanva, hex: "#00C4CC" },
};
