    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-900/60 backdrop-blur-md">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-slate-200/20 bg-white/95 px-4 sm:px-6 shadow-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Plus button for channels */}
          <button
            type="button"
            title="Kanal Ekle / Değiştir"
          ...
          <button
            type="button"
            className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50/80 px-3 py-1 text-xs font-semibold text-slate-700 hover:bg-slate-100 transition"
          >
            ...
            <span>{item.campaignName || "Kampanya"}</span>
          </button>
          ...
          {/* Onaya ata — the one pill in this row that's actually wired up
              (Campaign/Tags above are still decorative), so it's styled to
              stand out in rose instead of blending into the same
              gray-pill look as its non-functional neighbors. */}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            type="button"
            title="Geçmiş"
            className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 hover:bg-slate-100 transition hidden sm:flex"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="hidden sm:flex flex-col items-end pt-8 shrink-0 w-44 text-right">
              {!isActionable ? (
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs font-semibold text-slate-700">Sizin tarafınızdan onaylandı</span>
                  <button
                    type="button"
                    onClick={() => onToggleApprove(item.id)}
                    title="Onayı geri al"
                    className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 transition cursor-pointer"
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-300 bg-white text-slate-400 hover:border-emerald-500 hover:text-emerald-500 shadow-xs transition cursor-pointer"
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                    </svg>
